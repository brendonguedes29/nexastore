...
class ProjetoQualidade(BaseEmpresa):
    ...
    inicio=models.DateField(null=True,blank=True); fim=models.DateField(null=True,blank=True); status=models.CharField(max_length=20,choices=[('rascunho','Rascunho'),('andamento','Em andamento'),('concluido','Concluído')],default='rascunho')
...
class Treinamento(BaseEmpresa):
    ...
    pontos=models.PositiveIntegerField(default=100); obrigatorio=models.BooleanField(default=False); ativo=models.BooleanField(default=True)
    def __str__(self): return self.titulo
...
class TrilhaColaborador(BaseEmpresa):
    ...
    nota=models.DecimalField(max_digits=5,decimal_places=2,null=True,blank=True); concluido_em=models.DateTimeField(null=True,blank=True)
