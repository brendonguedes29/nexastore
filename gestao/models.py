...
class TrilhaColaborador(BaseEmpresa):
    ...
    nota=models.DecimalField(max_digits=5,decimal_places=2,null=True,blank=True); concluido_em=models.DateTimeField(null=True,blank=True); prazo=models.DateField(null=True,blank=True)
